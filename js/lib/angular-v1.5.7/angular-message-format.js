 ...
 * ## Example
 *
 * <example name="ngMessageFormat-example" module="msgFmtExample" deps="angular-v1.5.7-message-format.min.js">
 ...
 *
 *   angular-v1.5.7.module('msgFmtExample', ['ngMessageFormat'])
...
var $$interpolateDecorator = ['$$messageFormat', '$delegate', function $$interpolateDecorator($$messageFormat, $interpolate) {
  if ($interpolate['startSymbol']() != "{{" || $interpolate['endSymbol']() != "}}") {
    throw $interpolateMinErr('nochgmustache', 'angular-v1.5.7-message-format.js currently does not allow you to use custom start and end symbols for interpolation.');
  }
 ...
 * @packageName angular-v1.5.7-message-format
 * @description
 */
